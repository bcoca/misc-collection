...
DOCUMENTATION = '''
    name: cidr
    short_description: Parses CIDR expressions in host lists
    description:
        - Parses a host list string as a comma separated values of IP, hostnames or CIDR notations to generate inventory hosts
    notes:
        ...
        - Beware with big ranges, this will generage the host objects for each and might take a long time, specially with IPV6.
          Calculating a range is quick, but creating an inventory host object for each will add up fast.
'''
